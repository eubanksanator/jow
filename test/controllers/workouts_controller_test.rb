...
class WorkoutsControllerTest < ActionController::TestCase
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post :create, workout: { day_id: @workout.day_id, name: @workout.name, reps: @workout.reps, sets: @workout.sets }
    end
  ...
  test "should update workout" do
    patch :update, id: @workout, workout: { day_id: @workout.day_id, name: @workout.name, reps: @workout.reps, sets: @workout.sets }
    assert_redirected_to workout_path(assigns(:workout))
  end
